...
<div class="signup-form" style="margin-top: 10%">
       <form:form method="post" name="contact-form" action="${contextPath}/student/applyJob" modelAttribute="files" enctype="multipart/form-data">    
		<h2>Upload Files</h2>
        ...
        <div class="form-group">
        	...
        	<form:input type="file" class="form-control" path="resume" placeholder="Upload CV" required="required" style="height : 30px"/>
        </div>
		<div class="form-group">
			<label>Cover Letter</label>
            <form:input type="file" class="form-control" path="coverLetter" placeholder="Upload CoverLetter" required="required"  style="height : 30px" />
        </div>
		      
		<div class="form-group" style="margin-left:0%">
            <button type="submit" class="btn btn-success btn-lg btn-block" style="height : 40px">Apply</button>
        </div>
    </form:form>
